...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2023 at 10:10 AM
...
(95, 'Electronics', 'Electronics products', 'images/Electronic-Devices-1 (1).jpg', 109, 0),
...
(1, 0x66393130346566612d366331342d3131, 0, 'laptop hp 7th gen  ', 'image1.png', 'Electronic', 'sourabh kumawat', '43 awantipira ', 'Rajiv Gandhi indore  ', 'ujjain', 'mp', 'india', 456006, '2023-10-14', 'indore', 'indore', 'india', 456006, 10.00, 2, 2),
(2, 0x62626162373266652d366331342d3131, 0, '', '', '', '', '', '', '', '', '', 0, '2023-10-14', '', '', '', 0, 0.00, 0, 0),
(3, 0x31393736353862312d366331352d3131, 0, 'kkk', '', '', '', '', '', '', '', '', 0, '2023-09-12', '', '', '', 0, 0.00, 0, 1),
(6, 0x39363833623739372d366331342d3131, 3, 'ss', 'ds', 'ds', 'dssd', 'ds', 'dsds', 's', 's', 's', 3, '2023-10-02', '', '', '', 0, 0.00, 0, 2);
...
(342, 206, 'images/Ecommerce Admin-Order Management (3).jpg', '', 0, 0);
...
(206, 'Noise Halo Plus Elite Edition Smartwatch ', '  <ul>\r\n	<li>1.46 inches (3.7cms) AMOLED display, 466*466px, Always on display - Yes - Enjoy clear and immersive visuals on its round AMOLED display.</li>\r\n	<li>Up to 7-day battery life - Get up to 7 days of battery life &amp; up to 2 days of power with c', 4, 4, 'Electronic-Devices-1 (1).jpg', 50.00, 20.00, 1, 'skassal', '2023-10-08', 1),
(207, 'ssourabh', 'eee', 110, 160, '61VVef0Y5OL._SX569_.jpg', 4000.00, 0.00, 1, 'eee', '2023-10-10', 0),
(208, 's', 'www', 60, 2, '61VVef0Y5OL._SX569_.jpg', 2333.00, 0.00, 333, 'ewew', '2023-10-10', 0),
(210, 'sss', '', 2, 63, 'phone.jpg', 500.00, 120.00, 0, '', '1970-01-01', 1),
(211, '', '', 2, 2, 'shirt.jpg', 0.00, 0.00, 0, '', '1970-01-01', 1),
...
(249, 'sss', 'ss', 2, 95, 'images/Ecommerce Admin-Order Management (3).jpg', 45444.00, 556.00, 3, 'desds', '1970-01-01', 1);
...
--
ALTER TABLE `categories`
  MODIFY `category_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=205;
...
--
ALTER TABLE `media_master`
  MODIFY `product_image` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=343;

--
-- AUTO_INCREMENT for table `products`
--
ALTER TABLE `products`
  MODIFY `product_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=250;
...
--
ALTER TABLE `customer_order`
  ADD CONSTRAINT `customer_order_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
