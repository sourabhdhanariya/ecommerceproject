...
if (isset($_POST["submit"])) {
    ...
    if (
        ...
        if (
            ...
            try {
                $result = $obj->insertCategory("categories", $dataToInsert);
                if ($result === true) {
                    echo "Category Added Successfully.";
                } else {
                    echo "Error: " . implode(", ", $obj->getResult());
                }
            } catch (mysqli_sql_exception $e) {
                if ($e->getCode() === 1062) {
                    echo "Error: Category name already exists. Please choose a different name.";
                } else {
...
?>
i want show notification in toogle box 
...
<!-- <div class="col-md-6">
  ...
  <label for="">Category Image <span class="star">*</span></label>
    <input type="file" name="categoryImage" id="img-upload" class="form-control" id="inputCity">
  
</div>

<div class="col-md-4">

<img src="images/remove3.png" id="img-upload-tag"  class="categoryimage" alt="category"></div>
 -->
