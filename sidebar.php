                    ...
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li>
                                    <a href="category.php">
                                        <span class="pcoded-micon"><i class="bi bi-layout-split"></i><b>FC</b></span>
                                ...
                                <li>
                                    <a href="product.php">
                                        <span class="pcoded-micon"><i class="bi bi-book-fill"></i><b>FC</b></span>
                                ...
                                <li>
                                    <a href="bs-basic-table.html">
                                        <span class="pcoded-micon"><i class="bi bi-megaphone"></i><b>FC</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Promotions</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="bs-basic-table.html">
                                        <span class="pcoded-micon"><i class="bi bi-bell"></i><b>FC</b></span>
                                ...
                                <li>
                                    <a href="bs-basic-table.html">
                                        <span class="pcoded-micon"><i class="bi bi-question-circle"></i><b>FC</b></span>
                                ...
                                <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)">
                                        <span class="pcoded-micon"><i class="bi bi-file-earmark"></i></span>
                                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Static Pages</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class=" ">
                                            <a href="auth-sign-up.html">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Terms & Condition</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="sample-page.html">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Privacy Policy</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    </ul>
